...
namespace RaritetBooks.Infrastructure.Migrations
{
    ...
    [Migration("20250318170414_Initial")]
            ...
            modelBuilder.Entity("RaritetBooks.Domain.Entities.SellerRequest", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("RegistrationDate")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 3, 18, 17, 4, 13, 597, DateTimeKind.Unspecified).AddTicks(7746), new TimeSpan(0, 0, 0, 0, 0)))
            ...
            modelBuilder.Entity("RaritetBooks.Domain.Entities.UserSeller", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("RegistrationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 3, 18, 17, 4, 13, 583, DateTimeKind.Unspecified).AddTicks(5174), new TimeSpan(0, 0, 0, 0, 0)))
                        .HasColumnName("registration_date");

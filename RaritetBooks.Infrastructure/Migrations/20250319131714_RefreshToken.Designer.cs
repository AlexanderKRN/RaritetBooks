...
namespace RaritetBooks.Infrastructure.Migrations
{
    ...
    [Migration("20250319131714_RefreshToken")]
            ...
            modelBuilder.Entity("RaritetBooks.Domain.Entities.SellerRequest", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("RegistrationDate")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 3, 19, 13, 17, 11, 832, DateTimeKind.Unspecified).AddTicks(7226), new TimeSpan(0, 0, 0, 0, 0)))
            ...
            modelBuilder.Entity("RaritetBooks.Domain.Entities.UserSeller", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("RegistrationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 3, 19, 13, 17, 11, 722, DateTimeKind.Unspecified).AddTicks(101), new TimeSpan(0, 0, 0, 0, 0)))
                        .HasColumnName("registration_date");
